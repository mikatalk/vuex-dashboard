...
// color += vec3(.8, .2, .7) * doLines(uv, 1.+scrollRatio*PI, 60.0, .13);
// color += vec3(.8, .2, .7) * doLines(uv, 2.+scrollRatio*PI, 60.0, .13);
// color += vec3(.8, .2, .7) * doLines(uv, 3.+scrollRatio*PI, 60.0, .13);
